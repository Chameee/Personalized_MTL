...
DEFAULT_RESULTS_PATH = '/opt/tiger/mlx_notebook/outputs/'
DEFAULT_DATASETS_PATH = '/opt/tiger/mlx_notebook/Personalized_MTL/'
DEFAULT_FIGURES_PATH = '/opt/tiger/mlx_notebook/Personalized_MTL/'

DEFAULT_VAL_TYPE = 'cross'
OUTPUT_EVERY_NTH = 3

PATH_TO_REPO='/opt/tiger/mlx_notebook/Personalized_MTL/'
